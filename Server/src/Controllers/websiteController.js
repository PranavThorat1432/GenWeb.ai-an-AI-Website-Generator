...
export const generateWebsite = async (req, res) => {
    ...
    try {
        ...
        if(!user) {
            return res.status(400).json({
                message: 'You do not have enough credits to generate the website!'
            });
        }
        creditDeducted = true;
        ...
        return res.status(500).json({
            message: `Generate Website Error: ${error.message || error}`
        });
    }
};
...
export const getWebsiteById = async (req, res) => {
    try {
        ...
        return res.status(500).json({
            message: `Get Website Error: ${error}`
        });
    }
};
...
export const changes = async (req, res) => {
    ...
    try {
        ...
        if(!user) {
            return res.status(400).json({
                message: 'You do not have enough credits to modify the website!'
            });
        }
        creditDeducted = true;
        ...
        return res.status(500).json({
            message: `Update Website Error: ${error.message || error}`
        })
    }
};
